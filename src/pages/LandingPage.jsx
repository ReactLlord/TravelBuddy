...
import { TypewriterEffectSmoothDemo } from "../components/CustomHero/CustomHero";
...
export function HeroSectionOne() {
  ...
  const {IsSignUp, setIsSignUp} = useContext(TravelContext)
  return (
    <div
    ...
    <div className="px-4 py-10 md:py-20">
        ...
        <h1
          className="relative z-10 mx-auto max-w-4xl text-center text-3xl font-bold text-slate-700 md:text-4xl lg:text-7xl dark:text-slate-300">
          {"Plan Your Trip in Minutes, Not Days"
            .split(" ")
            .map((word, index) => (
              <motion.span
                key={index}
        ...
        With Travel Buddy’s smart AI, planning your perfect getaway takes Minutes—not days. Discover destinations, build custom itineraries, and explore local experiences with our cutting-edge AI tools.
...
const Footer = () => {
  return(
    <div className="bg-black text-white w-full h-[20vh]    place-content-center flex ">
      <p className="  place-self-center text-center mx-auto"> © 2025 All Rights Reserved. Made with 💖 by <span className="text-green-600"> <a href="https://ebun-oluwa.vercel.app/" target="_blank">Ebunoluwa</a></span></p>
    </div>
  )
}

const Navbar = () => {
  const {  setIsSignUp} = useContext(TravelContext)
  ...
  return (
    <nav
      ...
      <div className="flex items-center gap-2">
        ...
        <h1 className="text-base font-bold md:text-2xl">Travel Companion</h1>
      </div>
      <Link to ="/login">
