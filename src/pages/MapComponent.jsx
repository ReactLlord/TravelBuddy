        ...
        >
          {currentUser ? (
            ...
            <div className="buttons">
              <button className="button login zIndex: 1000" onClick={()=>{ setShowLogin(true); setShowRegister(false) }}>Login</button>
              <button className="button register zIndex: 1000" onClick={()=>{ setShowRegister(true); setShowLogin(false)}}>Register</button>
            </div>
          )}
        </div>
